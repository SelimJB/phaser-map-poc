...
export const controls: Control[] = [
  ...
  },
  {
    ...
    description: 'Same as blend factor, but for provinces that are hovered.',
    min: 0,
    max: 1,
    step: 0.1,
    defaultValue: 0.9,
  ...
  },
  {
    ...
    description: 'Same as grayscale blend factor, but for provinces that are hovered.',
    min: 0,
    max: 1,
    step: 0.1,
    defaultValue: 0.83,
  ...
  },
  {
    ...
    description:
      'Controls the intensity of the glow effect. At 0, the glow effect is completely off. At 1 the glow is super bright.',
    min: 1,
    max: 3,
    step: 0.1,
    defaultValue: 1.4,
  ...
  },
  {
    ...
    description: 'Controls the radius of the glow pulsation effect.',
    min: 0,
    max: 0.03,
    step: 0.001,
    defaultValue: 0.005,
  ...
  },
  {
    ...
    description: 'Controls the period of the glow pulsation effect.',
    min: 0,
    max: 8,
    step: 0.1,
    defaultValue: 5,
  ...
  },
  {
    ...
    description:
      'Controls the brightness of province borders. Lower values make borders darker, higher values make them brighter. Default is 1.',
    min: 0,
    max: 2,
    step: 0.05,
    defaultValue: 1,
  ...
  },
  {
    ...
    description: 'Controls the luminosity of the province contour.',
    min: -1,
    max: 1,
    step: 0.05,
    defaultValue: 0.05,
  ...
  },
  {
    ...
    description: 'Controls the opacity of the contour.',
    min: 0,
    max: 1,
    step: 0.1,
    defaultValue: 1,
  ...
  },
  {
    ...
    description: 'Controls the size of the inner contour.',
    min: 0,
    max: 0.01,
    step: 0.0005,
    defaultValue: 0.0045,
  ...
  },
  {
    ...
    description: 'Controls the number of samples used to draw the inner contour.',
    min: 0,
    max: 32,
    step: 1,
    defaultValue: 16,
  ...
  },
  {
    ...
    description: 'Controls the number of samples used to draw the glow and outer contour.',
    min: 0,
    max: 32,
    step: 1,
    defaultValue: 32,
  ...
  },
  {
    ...
    description: 'Controls the radius of the mouse illumination effect.',
    min: 0,
    max: 1,
    step: 0.005,
    defaultValue: 0.2,
  ...
  },
  {
    ...
    description: 'Controls the intensity of the mouse illumination effect.',
    min: 0,
    max: 1,
    step: 0.05,
    defaultValue: 0.12,
  ...
  },
  {
    ...
    description: 'Controls the intensity of the pulsation effect.',
    min: 0,
    max: 1,
    step: 0.1,
    defaultValue: 0.05,
  ...
  },
  {
    ...
    description: 'Controls the period of the pulsation effect.',
    min: 0,
    max: 10,
    step: 0.1,
    defaultValue: 5,
